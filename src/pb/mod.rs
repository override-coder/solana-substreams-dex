    ...
    pub mod solana {
        pub mod dex {
            pub mod jupiter_aggregator {
                // @@protoc_insertion_point(attribute:sf.solana.dex.jupiter_aggregator.v1)
                pub mod v1 {
                    include!("sf.solana.dex.jupiter_aggregator.v1.rs");
                    // @@protoc_insertion_point(sf.solana.dex.jupiter_aggregator.v1)
                }
            }
            pub mod meta {
            ...
            pub mod trades {
                ...
                pub mod v1 {
                    include!("sf.solana.dex.trades.v1.rs");
                    // @@protoc_insertion_point(sf.solana.dex.trades.v1)
                }
            }
        }
        pub mod r#type {
