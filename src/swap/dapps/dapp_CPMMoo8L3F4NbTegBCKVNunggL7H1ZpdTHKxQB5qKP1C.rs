...
const SWAP_BASE_INPUT_PARTNER_DISCRIMINATOR: u64 = u64::from_le_bytes([143, 190, 90, 218, 196, 30, 51, 222]);
const SWAP_BASE_OUTPUT_PARTNER_DISCRIMINATOR: u64 = u64::from_le_bytes([55, 217, 98, 86, 163, 74, 180, 173]);
    ...
    match discriminator {
        SWAP_BASE_INPUT_PARTNER_DISCRIMINATOR => {
            result = Some(TradeInstruction {
                program: String::from(RAYDIUM_CPMM_ADDRESS),
